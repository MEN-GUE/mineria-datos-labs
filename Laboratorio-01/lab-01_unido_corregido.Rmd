...
summary(data)
```
## Análisis En la exploración podemos notar que 
---
...
hp <- intersect(c("homepage","homePage","home_page","HomePage","official_homepage","website","site","url"), names(data))
data %>%
  mutate(
...
corr_castpop_rev <- cor(cast_pop$actorsPopularity_num, cast_pop$revenue, method = "spearman", use = "complete.obs")
corr_castpop_rev
```
